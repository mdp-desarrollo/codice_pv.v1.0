...
<div style="width: 800px;"><h2 class="subtitulo">MODIFICAR ACTIVIDAD<br/><span>Llene correctamente los datos en el formulario</span></h2>
<table border="0">
    <tr>
...
<form action="/pvplanificacion/editactividad/<?php echo $actividad->id;?>" method="post" id="frmCreate">

<table>
    <tr>
        <td><?php echo Form::label('codigo','Codigo')?></td>
        <td><?php echo Form::input('codigo',$actividad->codigo,array('name'=>'codigo','id'=>'codigo','class'=>'required')) ?></td>
    </tr>
    <tr>
        <td><?php echo Form::label('actividad','Actividad')?></td>
        <td><textarea id="actividad" name="actividad" class="required" rows="10"><?php echo $actividad->actividad?></textarea></td>
    </tr>
</table>

<input type="submit" value="Modificar" class="uibutton" name="submit" id="crear" title="Modificar Actividad."  />
</form>
