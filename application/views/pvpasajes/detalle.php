                        ...
                        <table id="x_tableMeta" class="classy" border="1">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Form::input('fecha_ida',dia_literal(date("w")).' '.date("Y-m-d"),array('id'=>'fecha_ida','size'=>'15','class'=>'required'));?><br /> <?php echo Form::input('hora_ida','00:00:00',array('id'=>'hora_ida','size'=>'10','class'=>'required'));?></td>
                                    <td><?php echo Form::input('fecha_llegada',dia_literal(date("w")).' '.date("Y-m-d"),array('id'=>'fecha_llegada','size'=>'15','class'=>'required'));?><br /><?php echo Form::input('hora_llegada','00:00:00',array('id'=>'hora_llegada','size'=>'10','class'=>'required'));?></td>
