...
<div class="info">
 ...
 <?php endif;?>
<form method="post" action="/admin/pvfuentes/save" id="frm">
    <?php     
    echo Form::hidden('id',$pvfuente->id);
    ?>
    <table>
        <tr>
            <td><?php echo Form::label('Codigo');?></td>
            <td><?php echo Form::input('codigo',$pvfuente->codigo,array('class'=>'required number'));?></td>
        </tr>
        <tr>
            <td><?php echo Form::label('Denominacion');?></td>
            <td><?php echo Form::input('denominacion',$pvfuente->denominacion,array('class'=>'required'));?></td>
        </tr>
        <tr>
            <td><?php echo Form::label('Sigla');?></td>
            <td><?php echo Form::input('sigla',$pvfuente->sigla,array('class'=>'required'));?></td>
        </tr>
        <tr>
            <td><?php echo Form::label('Tipo');?></td>
            <td><?php echo Form::input('tipo',$pvfuente->tipo,array('class'=>'required'));?></td>
        </tr>
    </table>
<hr/>
<br/>
